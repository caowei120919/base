...
public abstract class TreeListAdapter<T extends Node<T>> extends BaseAdapter {
    ...
    private OnExpandableItemClickListener<T> expandableListener;
    ...
    public void setExpandableItemClickListerner(OnExpandableItemClickListener<T> listener) {
