 ...
 * @Description :
 */
public class DataSourceOfAllAdapter extends RecyclerView.Adapter<DataSourceOfAllAdapter.ViewHolder> {
    private Context mContext ;
    private List<TableParamInfoBean.DataSourceBean> dataSourceBeans = new ArrayList<>();
    private LayoutInflater inflater ;
    private OnItemClick itemClick ;

    public DataSourceOfAllAdapter(Context mContext
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_datasource_all,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            itemClick.onAllClick(dataSourceBean);
        });
    }
    ...
    public interface OnItemClick{
        void onAllClick(TableParamInfoBean.DataSourceBean dataSourceBean);
    }
}
