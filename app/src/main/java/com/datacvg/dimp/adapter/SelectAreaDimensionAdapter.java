 ...
 * @Description : 组织维度适配器
 */
public class SelectAreaDimensionAdapter extends RecyclerView.Adapter<SelectAreaDimensionAdapter.ViewHolder> {

    private Context mContext ;
    private List<DimensionBean> orgIndexDimensionBeans = new ArrayList<>() ;
    private LayoutInflater inflater ;
    private SelectAreaDimensionClickListener clickListener ;

    public SelectAreaDimensionAdapter(Context mContext
            , List<DimensionBean> orgIndexDimensionBeans, SelectAreaDimensionClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            clickListener.onSelectAreaClick(orgIndexDimensionBeans.get(position));
        });
    }
    ...
    public interface SelectAreaDimensionClickListener{
        void onSelectAreaClick(DimensionBean bean);
    }
}
