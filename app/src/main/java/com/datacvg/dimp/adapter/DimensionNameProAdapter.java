 ...
 * @Description :
 */
public class DimensionNameProAdapter extends RecyclerView.Adapter<DimensionNameProAdapter.ViewHolder> {
    ...
    public DimensionNameProAdapter(Context mContext
            , List<DimensionForTimeBean.DimensionRelationBean.DimensionNameBean> dimensionNameBeans
            , DimensionNameProClickListener clickListener) {
    ...
    public interface DimensionNameProClickListener {
        void onDimensionProClick(DimensionForTimeBean.DimensionRelationBean.DimensionNameBean bean);
    }
}
