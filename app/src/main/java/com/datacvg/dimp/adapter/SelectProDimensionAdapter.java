 ...
 * @Description : 组织维度适配器
 */
public class SelectProDimensionAdapter extends RecyclerView.Adapter<SelectProDimensionAdapter.ViewHolder> {

    private Context mContext ;
    private List<DimensionBean> orgIndexDimensionBeans = new ArrayList<>() ;
    private SelectProClickListener clickListener ;
    private LayoutInflater inflater ;

    public SelectProDimensionAdapter(Context mContext
            , List<DimensionBean> orgIndexDimensionBeans
            , SelectProClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            clickListener.onSelectProClick(orgIndexDimensionBeans.get(position));
        });
    }
    ...
    public interface SelectProClickListener{
        void onSelectProClick(DimensionBean bean);
    }
}
