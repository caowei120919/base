...
public class IndexForDimensionTitleNavigator extends CommonNavigator {
    private int mPadding = DisplayUtils.dp2px(12);
    private List<IndexChartInfoBean.IndexChartDetailBean> items ;
    private Context mContext ;
    private OnTabSelectedListener mOnTabSelectedListener;
    private NavigatorAdapter adapter ;

    public IndexForDimensionTitleNavigator(Context context, List<IndexChartInfoBean.IndexChartDetailBean> titles) {
        super(context);
        mContext = context ;
        setAdjustMode(false);
        items = titles;
