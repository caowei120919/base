...
public  class ChooseIndexWindowDialog {

    private TextView tvTypeName ;
    private TextView tvHeadTypeName ;
    private RecyclerView recycleChoose ;
    private ChooseIndexAdapter adapter ;
    ...
    public ChooseIndexWindowDialog(Context context, List<ActionPlanIndexBean> actionPlanIndexBeans) {
        mContext = context ;
    ...
    private void convert(DialogViewHolder dialogVh) {
        ...
        tvTypeName.setText(mContext.getResources().getString(R.string.index_of_correlation));
        tvHeadTypeName = dialogVh.getConvertView().findViewById(R.id.tv_headTypeName);
        tvHeadTypeName.setText(mContext.getResources().getString(R.string.index));
        recycleChoose = dialogVh.getConvertView().findViewById(R.id.recycle_choose);

        layoutManager = new LinearLayoutManager(mContext);
        adapter = new ChooseIndexAdapter(mContext,actionPlanIndexBeans);
     ...
     * 显示dialog
     */
    public ChooseIndexWindowDialog showDialog() {
     ...
     * @return
     */
    public ChooseIndexWindowDialog backgroundLight(double light) {
     ...
     */
    @SuppressLint("NewApi")
    public ChooseIndexWindowDialog fromBottomToMiddle() {
     ...
     * 从底部弹出
     */
    public ChooseIndexWindowDialog fromBottom() {
        fromBottomToMiddle();
     ...
     * 从左边一直弹到中间退出也是到左边
     */
    public ChooseIndexWindowDialog fromLeftToMiddle() {
     ...
     * @return
     */
    public ChooseIndexWindowDialog fromRightToMiddle() {
     ...
     * @return
     */
    public ChooseIndexWindowDialog fromTop() {
        fromTopToMiddle();
     ...
     * @return
     */
    public ChooseIndexWindowDialog fromTopToMiddle() {
     ...
     * @return
     */
    public ChooseIndexWindowDialog showDialog(@StyleRes int style) {
     ...
     * @return
     */
    public ChooseIndexWindowDialog showDialog(boolean isAnimation) {
     ...
     * 全屏显示
     */
    public ChooseIndexWindowDialog fullScreen() {
    ...
    public ChooseIndexWindowDialog setOnKeyListener(DialogInterface.OnKeyListener onKeyListener){
     ...
     * 全屏宽度
     */
    public ChooseIndexWindowDialog fullWidth() {
        WindowManager.LayoutParams wl = mDialogWindow.getAttributes();
        wl.width = ViewGroup.LayoutParams.MATCH_PARENT;
        mDialog.onWindowAttributesChanged(wl);
        return this;
     ...
     * 全屏高度
     */
    public ChooseIndexWindowDialog fullHeight() {
        WindowManager.LayoutParams wl = mDialogWindow.getAttributes();
        wl.height = ViewGroup.LayoutParams.MATCH_PARENT;
        mDialog.onWindowAttributesChanged(wl);
        return this;
     ...
     * @return
     */
    public ChooseIndexWindowDialog setWidthAndHeight(int width, int height) {
        WindowManager.LayoutParams wl = mDialogWindow.getAttributes();
        wl.width = width;
        wl.height = height;
        mDialog.onWindowAttributesChanged(wl);
     ...
     * 设置监听
     */
    public ChooseIndexWindowDialog setDialogDismissListener(DialogInterface.OnDismissListener listener) {
     ...
     * 设置监听
     */
    public ChooseIndexWindowDialog setOnCancelListener(DialogInterface.OnCancelListener listener) {
     ...
     * 设置是否能取消
     */
    public ChooseIndexWindowDialog setCancelAble(boolean cancel) {
     ...
     * 设置触摸其他地方是否能取消
     */
    public ChooseIndexWindowDialog setCanceledOnTouchOutside(boolean cancel) {
