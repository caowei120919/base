...
public class ShareUtils {
    ...
    private Intent createShareIntent() {
        ...
        switch (contentType) {
            ...
            case ShareContentType.FILE:
                ...
                PLog.d(TAG, "Share uri: " + shareFileUri.toString());
                ...
                break;
            default:
                PLog.e(TAG, contentType + " is not support share type.");
                shareIntent = null;
                break;
        }
    ...
    private boolean checkShareParam() {
        ...
        if (TextUtils.isEmpty(this.contentType)) {
            PLog.e(TAG, "Share content type is empty.");
            return false;
        }

        if (ShareContentType.TEXT.equals(contentType)) {
            if (TextUtils.isEmpty(contentText)) {
                PLog.e(TAG, "Share text context is empty.");
                return false;
            }
        } else {
            if (this.shareFileUri == null) {
                PLog.e(TAG, "Share file path is null.");
                return false;
            }
        }
